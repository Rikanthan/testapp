  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            buildTextField('Material Name', materialController, true, false),
            buildTextField(
                'Frequency (Hz)', frequencyController, isEditable, true),
            buildTextField(
                'Mic 1 Pressure (P1)', p1Controller, isEditable, true),
            buildTextField(
                'Mic 2 Pressure (P2)', p2Controller, isEditable, true),
            buildTextField(
                'Distance to Mic 2 (x₁ in meters)', x1Controller, true, true),
